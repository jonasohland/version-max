...
namespace o {
    ...
    public:
        ...
        c74::min::atoms get_raw_version(c74::min::atoms args, int inlet) {
            ...
            if (ver_str[0] == 'v')
                ver_str = ver_str.erase(0, 1);

            std::vector<std::string> ver_str_elems;
            
            boost::algorithm::split(ver_str_elems, ver_str, boost::is_any_of("-,."));
        ...
        c74::min::message<> get_raw_version_m{ this, "raw", "Output current repository version as raw values", std::bind(&version::get_raw_version, this, std::placeholders::_1, std::placeholders::_2) };
